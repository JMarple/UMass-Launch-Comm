						       ...
						       uint16_t seq)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_WAYPOINT_CURRENT_LEN, MAVLINK_MSG_ID_WAYPOINT_CURRENT_CRC);
#else
						           ...
						           uint16_t seq)
{
	...
	msg->msgid = MAVLINK_MSG_ID_WAYPOINT_CURRENT;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_WAYPOINT_CURRENT_LEN, MAVLINK_MSG_ID_WAYPOINT_CURRENT_CRC);
#else
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WAYPOINT_CURRENT, buf, MAVLINK_MSG_ID_WAYPOINT_CURRENT_LEN, MAVLINK_MSG_ID_WAYPOINT_CURRENT_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WAYPOINT_CURRENT, buf, MAVLINK_MSG_ID_WAYPOINT_CURRENT_LEN);
#endif
#else
	mavlink_waypoint_current_t packet;
	packet.seq = seq;
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WAYPOINT_CURRENT, (const char *)&packet, MAVLINK_MSG_ID_WAYPOINT_CURRENT_LEN, MAVLINK_MSG_ID_WAYPOINT_CURRENT_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WAYPOINT_CURRENT, (const char *)&packet, MAVLINK_MSG_ID_WAYPOINT_CURRENT_LEN);
#endif
#endif
}
...
#else
	memcpy(waypoint_current, _MAV_PAYLOAD(msg), MAVLINK_MSG_ID_WAYPOINT_CURRENT_LEN);
#endif
}
