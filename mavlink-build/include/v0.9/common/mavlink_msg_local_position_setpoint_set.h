...
#define MAVLINK_MSG_ID_LOCAL_POSITION_SETPOINT_SET_CRC 206
#define MAVLINK_MSG_ID_50_CRC 206
						       ...
						       uint8_t target_system, uint8_t target_component, float x, float y, float z, float yaw)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_LOCAL_POSITION_SETPOINT_SET_LEN, MAVLINK_MSG_ID_LOCAL_POSITION_SETPOINT_SET_CRC);
#else
						           ...
						           uint8_t target_system,uint8_t target_component,float x,float y,float z,float yaw)
{
	...
	msg->msgid = MAVLINK_MSG_ID_LOCAL_POSITION_SETPOINT_SET;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_LOCAL_POSITION_SETPOINT_SET_LEN, MAVLINK_MSG_ID_LOCAL_POSITION_SETPOINT_SET_CRC);
#else
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_LOCAL_POSITION_SETPOINT_SET, buf, MAVLINK_MSG_ID_LOCAL_POSITION_SETPOINT_SET_LEN, MAVLINK_MSG_ID_LOCAL_POSITION_SETPOINT_SET_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_LOCAL_POSITION_SETPOINT_SET, buf, MAVLINK_MSG_ID_LOCAL_POSITION_SETPOINT_SET_LEN);
#endif
#else
	mavlink_local_position_setpoint_set_t packet;
	packet.target_system = target_system;
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_LOCAL_POSITION_SETPOINT_SET, (const char *)&packet, MAVLINK_MSG_ID_LOCAL_POSITION_SETPOINT_SET_LEN, MAVLINK_MSG_ID_LOCAL_POSITION_SETPOINT_SET_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_LOCAL_POSITION_SETPOINT_SET, (const char *)&packet, MAVLINK_MSG_ID_LOCAL_POSITION_SETPOINT_SET_LEN);
#endif
#endif
}
...
#else
	memcpy(local_position_setpoint_set, _MAV_PAYLOAD(msg), MAVLINK_MSG_ID_LOCAL_POSITION_SETPOINT_SET_LEN);
#endif
}
