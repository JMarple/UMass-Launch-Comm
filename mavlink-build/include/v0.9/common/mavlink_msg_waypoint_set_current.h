...
#define MAVLINK_MSG_ID_WAYPOINT_SET_CURRENT_CRC 106
#define MAVLINK_MSG_ID_41_CRC 106
						       ...
						       uint8_t target_system, uint8_t target_component, uint16_t seq)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_WAYPOINT_SET_CURRENT_LEN, MAVLINK_MSG_ID_WAYPOINT_SET_CURRENT_CRC);
#else
						           ...
						           uint8_t target_system,uint8_t target_component,uint16_t seq)
{
	...
	msg->msgid = MAVLINK_MSG_ID_WAYPOINT_SET_CURRENT;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_WAYPOINT_SET_CURRENT_LEN, MAVLINK_MSG_ID_WAYPOINT_SET_CURRENT_CRC);
#else
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WAYPOINT_SET_CURRENT, buf, MAVLINK_MSG_ID_WAYPOINT_SET_CURRENT_LEN, MAVLINK_MSG_ID_WAYPOINT_SET_CURRENT_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WAYPOINT_SET_CURRENT, buf, MAVLINK_MSG_ID_WAYPOINT_SET_CURRENT_LEN);
#endif
#else
	mavlink_waypoint_set_current_t packet;
	packet.target_system = target_system;
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WAYPOINT_SET_CURRENT, (const char *)&packet, MAVLINK_MSG_ID_WAYPOINT_SET_CURRENT_LEN, MAVLINK_MSG_ID_WAYPOINT_SET_CURRENT_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WAYPOINT_SET_CURRENT, (const char *)&packet, MAVLINK_MSG_ID_WAYPOINT_SET_CURRENT_LEN);
#endif
#endif
}
...
#else
	memcpy(waypoint_set_current, _MAV_PAYLOAD(msg), MAVLINK_MSG_ID_WAYPOINT_SET_CURRENT_LEN);
#endif
}
