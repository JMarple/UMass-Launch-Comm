						       ...
						       uint32_t utc_date, uint32_t utc_time)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_SYSTEM_TIME_UTC_LEN, MAVLINK_MSG_ID_SYSTEM_TIME_UTC_CRC);
#else
						           ...
						           uint32_t utc_date,uint32_t utc_time)
{
	...
	msg->msgid = MAVLINK_MSG_ID_SYSTEM_TIME_UTC;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_SYSTEM_TIME_UTC_LEN, MAVLINK_MSG_ID_SYSTEM_TIME_UTC_CRC);
#else
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SYSTEM_TIME_UTC, buf, MAVLINK_MSG_ID_SYSTEM_TIME_UTC_LEN, MAVLINK_MSG_ID_SYSTEM_TIME_UTC_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SYSTEM_TIME_UTC, buf, MAVLINK_MSG_ID_SYSTEM_TIME_UTC_LEN);
#endif
#else
	mavlink_system_time_utc_t packet;
	packet.utc_date = utc_date;
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SYSTEM_TIME_UTC, (const char *)&packet, MAVLINK_MSG_ID_SYSTEM_TIME_UTC_LEN, MAVLINK_MSG_ID_SYSTEM_TIME_UTC_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SYSTEM_TIME_UTC, (const char *)&packet, MAVLINK_MSG_ID_SYSTEM_TIME_UTC_LEN);
#endif
#endif
}
...
#else
	memcpy(system_time_utc, _MAV_PAYLOAD(msg), MAVLINK_MSG_ID_SYSTEM_TIME_UTC_LEN);
#endif
}
