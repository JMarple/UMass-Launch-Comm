						       ...
						       uint16_t seq)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_WAYPOINT_REACHED_LEN, MAVLINK_MSG_ID_WAYPOINT_REACHED_CRC);
#else
						           ...
						           uint16_t seq)
{
	...
	msg->msgid = MAVLINK_MSG_ID_WAYPOINT_REACHED;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_WAYPOINT_REACHED_LEN, MAVLINK_MSG_ID_WAYPOINT_REACHED_CRC);
#else
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WAYPOINT_REACHED, buf, MAVLINK_MSG_ID_WAYPOINT_REACHED_LEN, MAVLINK_MSG_ID_WAYPOINT_REACHED_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WAYPOINT_REACHED, buf, MAVLINK_MSG_ID_WAYPOINT_REACHED_LEN);
#endif
#else
	mavlink_waypoint_reached_t packet;
	packet.seq = seq;
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WAYPOINT_REACHED, (const char *)&packet, MAVLINK_MSG_ID_WAYPOINT_REACHED_LEN, MAVLINK_MSG_ID_WAYPOINT_REACHED_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WAYPOINT_REACHED, (const char *)&packet, MAVLINK_MSG_ID_WAYPOINT_REACHED_LEN);
#endif
#endif
}
...
#else
	memcpy(waypoint_reached, _MAV_PAYLOAD(msg), MAVLINK_MSG_ID_WAYPOINT_REACHED_LEN);
#endif
}
