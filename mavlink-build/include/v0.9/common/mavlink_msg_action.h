						       ...
						       uint8_t target, uint8_t target_component, uint8_t action)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_ACTION_LEN, MAVLINK_MSG_ID_ACTION_CRC);
#else
						           ...
						           uint8_t target,uint8_t target_component,uint8_t action)
{
	...
	msg->msgid = MAVLINK_MSG_ID_ACTION;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_ACTION_LEN, MAVLINK_MSG_ID_ACTION_CRC);
#else
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ACTION, buf, MAVLINK_MSG_ID_ACTION_LEN, MAVLINK_MSG_ID_ACTION_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ACTION, buf, MAVLINK_MSG_ID_ACTION_LEN);
#endif
#else
	mavlink_action_t packet;
	packet.target = target;
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ACTION, (const char *)&packet, MAVLINK_MSG_ID_ACTION_LEN, MAVLINK_MSG_ID_ACTION_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ACTION, (const char *)&packet, MAVLINK_MSG_ID_ACTION_LEN);
#endif
#endif
}
...
#else
	memcpy(action, _MAV_PAYLOAD(msg), MAVLINK_MSG_ID_ACTION_LEN);
#endif
}
