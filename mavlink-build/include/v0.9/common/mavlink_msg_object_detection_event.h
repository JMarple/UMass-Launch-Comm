						       ...
						       uint32_t time, uint16_t object_id, uint8_t type, const char *name, uint8_t quality, float bearing, float distance)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_OBJECT_DETECTION_EVENT_LEN, MAVLINK_MSG_ID_OBJECT_DETECTION_EVENT_CRC);
#else
						           ...
						           uint32_t time,uint16_t object_id,uint8_t type,const char *name,uint8_t quality,float bearing,float distance)
{
	...
	msg->msgid = MAVLINK_MSG_ID_OBJECT_DETECTION_EVENT;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_OBJECT_DETECTION_EVENT_LEN, MAVLINK_MSG_ID_OBJECT_DETECTION_EVENT_CRC);
#else
...
static inline void mavlink_msg_object_detection_event_send(mavlink_channel_t chan, uint32_t time, uint16_t object_id, uint8_t type, const char *name, uint8_t quality, float bearing, float distance)
{
	...
	_mav_put_char_array(buf, 7, name, 20);
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_OBJECT_DETECTION_EVENT, buf, MAVLINK_MSG_ID_OBJECT_DETECTION_EVENT_LEN, MAVLINK_MSG_ID_OBJECT_DETECTION_EVENT_CRC);
#else
	...
	mav_array_memcpy(packet.name, name, sizeof(char)*20);
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_OBJECT_DETECTION_EVENT, (const char *)&packet, MAVLINK_MSG_ID_OBJECT_DETECTION_EVENT_LEN, MAVLINK_MSG_ID_OBJECT_DETECTION_EVENT_CRC);
#else
