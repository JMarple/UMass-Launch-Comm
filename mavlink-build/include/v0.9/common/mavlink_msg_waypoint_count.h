...
#define MAVLINK_MSG_ID_WAYPOINT_COUNT_CRC 4
#define MAVLINK_MSG_ID_44_CRC 4
						       ...
						       uint8_t target_system, uint8_t target_component, uint16_t count)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_WAYPOINT_COUNT_LEN, MAVLINK_MSG_ID_WAYPOINT_COUNT_CRC);
#else
						           ...
						           uint8_t target_system,uint8_t target_component,uint16_t count)
{
	...
	msg->msgid = MAVLINK_MSG_ID_WAYPOINT_COUNT;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_WAYPOINT_COUNT_LEN, MAVLINK_MSG_ID_WAYPOINT_COUNT_CRC);
#else
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WAYPOINT_COUNT, buf, MAVLINK_MSG_ID_WAYPOINT_COUNT_LEN, MAVLINK_MSG_ID_WAYPOINT_COUNT_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WAYPOINT_COUNT, buf, MAVLINK_MSG_ID_WAYPOINT_COUNT_LEN);
#endif
#else
	mavlink_waypoint_count_t packet;
	packet.target_system = target_system;
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WAYPOINT_COUNT, (const char *)&packet, MAVLINK_MSG_ID_WAYPOINT_COUNT_LEN, MAVLINK_MSG_ID_WAYPOINT_COUNT_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WAYPOINT_COUNT, (const char *)&packet, MAVLINK_MSG_ID_WAYPOINT_COUNT_LEN);
#endif
#endif
}
...
#else
	memcpy(waypoint_count, _MAV_PAYLOAD(msg), MAVLINK_MSG_ID_WAYPOINT_COUNT_LEN);
#endif
}
