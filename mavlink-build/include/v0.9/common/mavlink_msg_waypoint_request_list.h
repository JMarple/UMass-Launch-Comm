						       ...
						       uint8_t target_system, uint8_t target_component)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_WAYPOINT_REQUEST_LIST_LEN, MAVLINK_MSG_ID_WAYPOINT_REQUEST_LIST_CRC);
#else
						           ...
						           uint8_t target_system,uint8_t target_component)
{
	...
	msg->msgid = MAVLINK_MSG_ID_WAYPOINT_REQUEST_LIST;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_WAYPOINT_REQUEST_LIST_LEN, MAVLINK_MSG_ID_WAYPOINT_REQUEST_LIST_CRC);
#else
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WAYPOINT_REQUEST_LIST, buf, MAVLINK_MSG_ID_WAYPOINT_REQUEST_LIST_LEN, MAVLINK_MSG_ID_WAYPOINT_REQUEST_LIST_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WAYPOINT_REQUEST_LIST, buf, MAVLINK_MSG_ID_WAYPOINT_REQUEST_LIST_LEN);
#endif
#else
	mavlink_waypoint_request_list_t packet;
	packet.target_system = target_system;
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WAYPOINT_REQUEST_LIST, (const char *)&packet, MAVLINK_MSG_ID_WAYPOINT_REQUEST_LIST_LEN, MAVLINK_MSG_ID_WAYPOINT_REQUEST_LIST_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WAYPOINT_REQUEST_LIST, (const char *)&packet, MAVLINK_MSG_ID_WAYPOINT_REQUEST_LIST_LEN);
#endif
#endif
}
...
#else
	memcpy(waypoint_request_list, _MAV_PAYLOAD(msg), MAVLINK_MSG_ID_WAYPOINT_REQUEST_LIST_LEN);
#endif
}
