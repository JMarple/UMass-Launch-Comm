...
#define MAVLINK_MSG_ID_WAYPOINT_REQUEST_CRC 9
#define MAVLINK_MSG_ID_40_CRC 9
						       ...
						       uint8_t target_system, uint8_t target_component, uint16_t seq)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_WAYPOINT_REQUEST_LEN, MAVLINK_MSG_ID_WAYPOINT_REQUEST_CRC);
#else
						           ...
						           uint8_t target_system,uint8_t target_component,uint16_t seq)
{
	...
	msg->msgid = MAVLINK_MSG_ID_WAYPOINT_REQUEST;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_WAYPOINT_REQUEST_LEN, MAVLINK_MSG_ID_WAYPOINT_REQUEST_CRC);
#else
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WAYPOINT_REQUEST, buf, MAVLINK_MSG_ID_WAYPOINT_REQUEST_LEN, MAVLINK_MSG_ID_WAYPOINT_REQUEST_CRC);
#else
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WAYPOINT_REQUEST, (const char *)&packet, MAVLINK_MSG_ID_WAYPOINT_REQUEST_LEN, MAVLINK_MSG_ID_WAYPOINT_REQUEST_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_WAYPOINT_REQUEST, (const char *)&packet, MAVLINK_MSG_ID_WAYPOINT_REQUEST_LEN);
#endif
#endif
}
...
#else
	memcpy(waypoint_request, _MAV_PAYLOAD(msg), MAVLINK_MSG_ID_WAYPOINT_REQUEST_LEN);
#endif
}
