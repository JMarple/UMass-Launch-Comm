						       ...
						       uint8_t action, uint8_t result)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_ACTION_ACK_LEN, MAVLINK_MSG_ID_ACTION_ACK_CRC);
#else
						           ...
						           uint8_t action,uint8_t result)
{
	...
	msg->msgid = MAVLINK_MSG_ID_ACTION_ACK;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_ACTION_ACK_LEN, MAVLINK_MSG_ID_ACTION_ACK_CRC);
#else
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ACTION_ACK, buf, MAVLINK_MSG_ID_ACTION_ACK_LEN, MAVLINK_MSG_ID_ACTION_ACK_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ACTION_ACK, buf, MAVLINK_MSG_ID_ACTION_ACK_LEN);
#endif
#else
	mavlink_action_ack_t packet;
	packet.action = action;
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ACTION_ACK, (const char *)&packet, MAVLINK_MSG_ID_ACTION_ACK_LEN, MAVLINK_MSG_ID_ACTION_ACK_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ACTION_ACK, (const char *)&packet, MAVLINK_MSG_ID_ACTION_ACK_LEN);
#endif
#endif
}
...
#else
	memcpy(action_ack, _MAV_PAYLOAD(msg), MAVLINK_MSG_ID_ACTION_ACK_LEN);
#endif
}
